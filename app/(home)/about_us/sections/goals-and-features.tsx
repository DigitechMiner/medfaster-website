    ...
    <Section className="bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          ...
          <ResponsiveParagraph size="sm" className="text-[#717680] mt-4 max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
          {CORE_GOALS.map((goal, index) => (
            <div
              key={index}
              className="flex flex-col items-start space-y-4 p-6 rounded-lg bg-white border border-gray-200 hover:border-[#F4781B] transition-all duration-300 hover:shadow-md"
            >
              ...
              <Paragraph size="lg" weight="semibold" className="text-[#252B37]">
                {goal.title}
              </Paragraph>

              <Paragraph size="lg" className="text-[#717680] leading-relaxed">
                {goal.description}
              </Paragraph>
            </div>
          ))}
